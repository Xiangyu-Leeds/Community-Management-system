...
<div class="container" style="background-color: #248cf5">
    <div class="logo"><a href="./index.html">员工社区系统</a></div>
    <div class="left_open">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                            ...
                            <li>
                                <a _href="${ctx }/page/apply.jsp">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>差假申请</cite>
                                </a>
                            </li>
                            <li>
                                <a _href="${ctx }/worker/myHistory?name=${sessionScope.userName}">
                                    <i class="iconfont">&#xe6a7;</i>
                                    <cite>历史请假</cite>
                                </a>
                            </li>
...
boolean f = (boolean)request.getAttribute("bool");
String job = (String)request.getAttribute("myJob");
session.setAttribute("myJob",job);
session.setAttribute("bool",f);
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='${ctx}/page/welcome2.jsp' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
</div>
